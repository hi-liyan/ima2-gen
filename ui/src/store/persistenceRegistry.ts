...
export const SEEN_HISTORY_ITEM_KEYS_STORAGE_KEY = PERSISTED_KEYS[23];
...
> = {
  ...
  "ima2.seenHistoryItemKeys": { domain: "gallery", shape: "json:string[]", resetSafe: true },
};
